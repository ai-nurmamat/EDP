...
- [架构总览](#架构总览)
- [概率思维哲学](#概率思维哲学-我们不赌最可能发生的而是赌价值被低估的)
...
┌──────────────────────────────────────────────────────────────────────────────┐
│  我们不赌：赔率最低的（最可能发生的）                                          │
│  我们赌：市场赔率 > 真实概率对应赔率（正期望值）                               │
│                                                                               │
│  关键洞察：即使80%的投注失败，只要20%的成功能够覆盖所有损失并盈利               │
└──────────────────────────────────────────────────────────────────────────────┘
```
...
```
EV = 0.15 × 7 - 0.85 × 1 = 1.05 - 0.85 = +0.20 每单位投注
```
